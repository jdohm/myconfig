...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(
                                       ...
                                       ;; treemacs-evil
    ;;ox-reveal
                                      ;; nicht maintained, funktioniert nicht...
                                      ;;latex-extra
                                      telega
                                      )
...
you should place your code here."
  ...
  ;; change :q from closing whole emacs to only close the current window
  (evil-ex-define-cmd "q[uit]" 'kill-this-buffer )

  ;; ignore pairs in latex mode to speed up
  ;; https://github.com/Fuco1/smartparens/issues/1013
  ...
  (setq org-todo-keywords
                                       '((sequence "TODO(t!)" "NEXT(n!)" "WIP(w!)" "BLOCKED(b!)" "DELEGATED(D!)" "FOLLOWUP(f!)" "|" "CANCELLED(c!)" "DONE(d!)")))
  ...
  ;; (global-set-key (kbd "C-c z") 'helm-bibtex-with-local-bibliography)
  ...
  ;; show clock in hours and mins instead of days
  (setq org-duration-format (quote h:mm))

  ;; run LaTeX snippets inside org mode
